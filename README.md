...
- [gflow-cli](https://github.com/ffroliva/gflow-cli/tree/develop/skills/gflow-cli) - Drives Google Flow from Claude Code: Veo text-to-video, image-to-video and clip extension, plus Imagen image generation. Needs the `gflow` CLI installed and a Google account with Flow access; video generation bills that account's credits.
